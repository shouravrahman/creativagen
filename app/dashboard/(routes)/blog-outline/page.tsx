...
import { CheckIcon, Code, ListChecks } from "lucide-react";
...
const BlogOutlinePage = () => {
	...
	const onSubmit = async (values: z.infer<typeof formSchema>) => {
		try {
			...
			const response = await axios.post("/api/blog-outline", {
	...
	return (
		<div>
			<Heading
				...
				description='Generate Blog Outline just give the topic.'
				icon={ListChecks}
