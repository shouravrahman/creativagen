      ...
      >
        {selectedTemplate?.formFields?.map((f) => {
          ...
          switch (f.field) {
            case "input":
              return (
                <div key={f.label} className="my-8 flex flex-col gap-1">
            ...
            case "select":
              return (
                <div
                  key={f.label}
                  className="my-8 relative flex flex-col gap-1"
                >
                  <Label className="mb-1" htmlFor={f.name}>
                    {f.label}
                  </Label>
            ...
            case "radiogroup":
              return (
                <div className="my-8 pl-1" key={f.label}>
            ...
            case "switch":
              return (
                <div
                  key={f.label}
                  className="text-center px-4 inline-flex  items-center  space-x-2 my-8"
                >
                  {/* <Switch
                    id={f.name}
                    {...form.register(f.name)}
