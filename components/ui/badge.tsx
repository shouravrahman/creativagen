   ...
   "inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-all duration-200 shadow-sm backdrop-blur-[2px]",
   {
      variants: {
         variant: {
            ...
            premium: "bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 text-foreground hover:shadow-sm hover:scale-105 hover:brightness-110 border-0 animate-gradient",
         },
      },
      defaultVariants: {
         variant: "default",
