...
const buttonVariants = cva(
   "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
   {
      variants: {
         variant: {
            default: "bg-primary text-primary-foreground dark:text-foreground  shadow-sm hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
            destructive: "bg-accent text-black/80 font-semibold shadow-sm hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
            outline: "border-2 border-border bg-background hover:bg-accent hover:text-black",
            secondary: "bg-sidebar text-sidebar-text shadow-sm hover:brightness-110 hover:scale-[1.02] active:scale-[0.98]",
