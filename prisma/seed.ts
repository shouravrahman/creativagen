		...
		},
		{
			...
			formFields: [
				...
				},
				{
					...
					order: 4,
					helpText:
						"Include specific technical analysis in your post?",
				},
				{
  ...
  6. Revenue Model: Propose pricing structure and potential revenue streams`,
			...
			formFields: [
				...
				},
				{
					...
					order: 2,
					helpText:
						"e.g., Real Estate Agent, Legal Assistant, Teacher",
				},
			],
		},
		{
		...
		},
		{
			...
			formFields: [
				...
				},
				{
					...
					order: 2,
					helpText:
						"e.g., E-commerce platform, AI-powered application",
				},
			],
		},
		{
		...
		},
		{
			...
			formFields: [
				...
				},
				{
					...
					order: 3,
					helpText:
						"e.g., Next.js website development, SEO optimization",
				},
			],
		},
	];
